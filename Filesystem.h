...
//******** OS_MountDirectory ************
// Pulls filesystem into memory from Flash
...
// This function will replace the current last sector
// of a file with the buffer (useful for file appending w/in sector)
